...
from ....types.accounts.favorite import movie_list_params
from ....types.accounts.favorite.movie_list_response import MovieListResponse
...
class MoviesResource(SyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        """
        return self._get(
            f"/3/account/{account_id}/favorite/movies",
