...
from ...types.tv import account_state_retrieve_params
...
from ...types.tv.account_state_retrieve_response import AccountStateRetrieveResponse
...
class AccountStatesResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        """
        return self._get(
            f"/3/tv/{series_id}/account_states",
