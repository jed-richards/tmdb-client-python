...
from ....types.tv.seasons import image_retrieve_params
from ....types.tv.seasons.image_retrieve_response import ImageRetrieveResponse
...
class ImagesResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        """
        return self._get(
            f"/3/tv/{series_id}/season/{season_number}/images",
