...
from ....types.tv.seasons import aggregate_credit_retrieve_params
from ....types.tv.seasons.aggregate_credit_retrieve_response import AggregateCreditRetrieveResponse
...
class AggregateCreditsResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        """
        return self._get(
            f"/3/tv/{series_id}/season/{season_number}/aggregate_credits",
