...
from ....types.tv.seasons import credit_retrieve_params
from ....types.tv.seasons.credit_retrieve_response import CreditRetrieveResponse
...
class CreditsResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        """
        return self._get(
            f"/3/tv/{series_id}/season/{season_number}/credits",
