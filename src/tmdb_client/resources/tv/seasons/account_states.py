...
from ....types.tv.seasons import account_state_retrieve_params
from ....types.tv.seasons.account_state_retrieve_response import AccountStateRetrieveResponse
...
class AccountStatesResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        """
        return self._get(
            f"/3/tv/{series_id}/season/{season_number}/account_states",
