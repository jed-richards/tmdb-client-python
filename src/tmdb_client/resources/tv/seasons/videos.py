...
from ....types.tv.seasons import video_list_params
from ....types.tv.seasons.video_list_response import VideoListResponse
...
class VideosResource(SyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        """
        return self._get(
            f"/3/tv/{series_id}/season/{season_number}/videos",
