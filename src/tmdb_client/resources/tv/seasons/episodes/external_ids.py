...
from .....types.tv.seasons.episodes.external_id_list_response import ExternalIDListResponse
    ...
    def list(
        ...
        *,
        ...
        if not episode_number:
            raise ValueError(f"Expected a non-empty value for `episode_number` but received {episode_number!r}")
        return self._get(
            f"/3/tv/{series_id}/season/{season_number}/episode/{episode_number}/external_ids",
