...
from .....types.tv.seasons.episodes.translation_list_response import TranslationListResponse
...
class TranslationsResource(SyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        """
        return self._get(
            f"/3/tv/{series_id}/season/{season_number}/episode/{episode_number}/translations",
