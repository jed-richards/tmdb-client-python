...
from ...types.guest_sessions import tv_episode_list_params
from ...types.guest_sessions.tv_episode_list_response import TvEpisodeListResponse
...
class TvEpisodesResource(SyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        return self._get(
            f"/3/guest_session/{guest_session_id}/rated/tv/episodes",
