...
from ...types.tv_shows import recommendation_list_params
from ...types.tv_shows.recommendation_list_response import RecommendationListResponse
...
class RecommendationsResource(SyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        """
        return self._get(
            f"/3/tv/{series_id}/recommendations",
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    recommendation_list_params.RecommendationListParams,
                ),
            ),
            cast_to=RecommendationListResponse,
        )
