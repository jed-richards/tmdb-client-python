...
from ...types.movies import alternative_title_retrieve_params
from ...types.movies.alternative_title_retrieve_response import AlternativeTitleRetrieveResponse
...
class AlternativeTitlesResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        """
        return self._get(
            f"/3/movie/{movie_id}/alternative_titles",
            options=make_request_options(
                ...
                query=maybe_transform(
                    {"country": country}, alternative_title_retrieve_params.AlternativeTitleRetrieveParams
                ),
            ),
