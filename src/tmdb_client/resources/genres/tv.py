...
from ...types.genres import tv_list_params
from ...types.genres.tv_list_response import TvListResponse
        ...
        *,
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                timeout=timeout,
                query=maybe_transform({"language": language}, tv_list_params.TvListParams),
            ),
        ...
        *,
        ...
        return await self._get(
            ...
            options=make_request_options(
                ...
                extra_body=extra_body,
                timeout=timeout,
                query=await async_maybe_transform({"language": language}, tv_list_params.TvListParams),
            ),
            cast_to=TvListResponse,
        )
