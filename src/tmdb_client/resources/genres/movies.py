...
from ...types.genres import movie_list_params
from ...types.genres.movie_list_response import MovieListResponse
        ...
        *,
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                timeout=timeout,
                query=maybe_transform({"language": language}, movie_list_params.MovieListParams),
            ),
        ...
        *,
        ...
        return await self._get(
            ...
            options=make_request_options(
                ...
                extra_body=extra_body,
                timeout=timeout,
                query=await async_maybe_transform({"language": language}, movie_list_params.MovieListParams),
            ),
            cast_to=MovieListResponse,
        )
