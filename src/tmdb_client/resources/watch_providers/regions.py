...
from ...types.watch_providers import region_list_params
from ...types.watch_providers.region_list_response import RegionListResponse
        ...
        *,
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                timeout=timeout,
                query=maybe_transform({"language": language}, region_list_params.RegionListParams),
            ),
        ...
        *,
        ...
        return await self._get(
            ...
            options=make_request_options(
                ...
                extra_body=extra_body,
                timeout=timeout,
                query=await async_maybe_transform({"language": language}, region_list_params.RegionListParams),
            ),
            cast_to=RegionListResponse,
        )
