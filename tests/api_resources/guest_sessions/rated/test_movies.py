...
class TestMovies:
    ...
    def test_method_list(self, client: TmdbClient) -> None:
        movie = client.guest_sessions.rated.movies.list(
    ...
    def test_raw_response_list(self, client: TmdbClient) -> None:
        response = client.guest_sessions.rated.movies.with_raw_response.list(
            guest_session_id="guest_session_id",
        )
    ...
    def test_streaming_response_list(self, client: TmdbClient) -> None:
        with client.guest_sessions.rated.movies.with_streaming_response.list(
            guest_session_id="guest_session_id",
        ) as response:
    ...
    def test_path_params_list(self, client: TmdbClient) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `guest_session_id` but received ''"):
            client.guest_sessions.rated.movies.with_raw_response.list(
                guest_session_id="",
            )
...
class TestAsyncMovies:
    ...
    async def test_method_list(self, async_client: AsyncTmdbClient) -> None:
        movie = await async_client.guest_sessions.rated.movies.list(
            guest_session_id="guest_session_id",
        )
        assert_matches_type(MovieListResponse, movie, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncTmdbClient) -> None:
        response = await async_client.guest_sessions.rated.movies.with_raw_response.list(
            guest_session_id="guest_session_id",
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncTmdbClient) -> None:
        async with async_client.guest_sessions.rated.movies.with_streaming_response.list(
            guest_session_id="guest_session_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_list(self, async_client: AsyncTmdbClient) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `guest_session_id` but received ''"):
            await async_client.guest_sessions.rated.movies.with_raw_response.list(
                guest_session_id="",
            )
