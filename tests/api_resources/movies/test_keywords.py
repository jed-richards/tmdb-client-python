...
class TestKeywords:
    ...
    def test_method_retrieve(self, client: TmdbClient) -> None:
        keyword = client.movies.keywords.retrieve(
            "movie_id",
        )
    ...
    def test_raw_response_retrieve(self, client: TmdbClient) -> None:
        response = client.movies.keywords.with_raw_response.retrieve(
            "movie_id",
        )
    ...
    def test_streaming_response_retrieve(self, client: TmdbClient) -> None:
        with client.movies.keywords.with_streaming_response.retrieve(
            "movie_id",
        ) as response:
    ...
    def test_path_params_retrieve(self, client: TmdbClient) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `movie_id` but received ''"):
            client.movies.keywords.with_raw_response.retrieve(
                "",
            )
...
class TestAsyncKeywords:
    ...
    async def test_method_retrieve(self, async_client: AsyncTmdbClient) -> None:
        keyword = await async_client.movies.keywords.retrieve(
            "movie_id",
        )
        assert_matches_type(KeywordRetrieveResponse, keyword, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncTmdbClient) -> None:
        response = await async_client.movies.keywords.with_raw_response.retrieve(
            "movie_id",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncTmdbClient) -> None:
        async with async_client.movies.keywords.with_streaming_response.retrieve(
            "movie_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_retrieve(self, async_client: AsyncTmdbClient) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `movie_id` but received ''"):
            await async_client.movies.keywords.with_raw_response.retrieve(
                "",
            )
