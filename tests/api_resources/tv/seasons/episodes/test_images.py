...
class TestImages:
    ...
    def test_method_retrieve(self, client: TmdbClient) -> None:
        image = client.tv.seasons.episodes.images.retrieve(
            episode_number=0,
            series_id=0,
            season_number=0,
        )
    ...
    def test_raw_response_retrieve(self, client: TmdbClient) -> None:
        response = client.tv.seasons.episodes.images.with_raw_response.retrieve(
            episode_number=0,
            series_id=0,
            season_number=0,
        )
    ...
    def test_streaming_response_retrieve(self, client: TmdbClient) -> None:
        with client.tv.seasons.episodes.images.with_streaming_response.retrieve(
            episode_number=0,
            series_id=0,
            season_number=0,
        ) as response:
...
class TestAsyncImages:
    ...
    async def test_method_retrieve(self, async_client: AsyncTmdbClient) -> None:
        image = await async_client.tv.seasons.episodes.images.retrieve(
            episode_number=0,
            series_id=0,
            season_number=0,
        )
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncTmdbClient) -> None:
        response = await async_client.tv.seasons.episodes.images.with_raw_response.retrieve(
            episode_number=0,
            series_id=0,
            season_number=0,
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncTmdbClient) -> None:
        async with async_client.tv.seasons.episodes.images.with_streaming_response.retrieve(
            episode_number=0,
            series_id=0,
            season_number=0,
        ) as response:
