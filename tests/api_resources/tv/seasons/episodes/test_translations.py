...
class TestTranslations:
    ...
    def test_method_list(self, client: TmdbClient) -> None:
        translation = client.tv.seasons.episodes.translations.list(
            episode_number=0,
            series_id=0,
            season_number=0,
        )
    ...
    def test_raw_response_list(self, client: TmdbClient) -> None:
        response = client.tv.seasons.episodes.translations.with_raw_response.list(
            episode_number=0,
            series_id=0,
            season_number=0,
        )
    ...
    def test_streaming_response_list(self, client: TmdbClient) -> None:
        with client.tv.seasons.episodes.translations.with_streaming_response.list(
            episode_number=0,
            series_id=0,
            season_number=0,
        ) as response:
...
class TestAsyncTranslations:
    ...
    async def test_method_list(self, async_client: AsyncTmdbClient) -> None:
        translation = await async_client.tv.seasons.episodes.translations.list(
            episode_number=0,
            series_id=0,
            season_number=0,
        )
    ...
    async def test_raw_response_list(self, async_client: AsyncTmdbClient) -> None:
        response = await async_client.tv.seasons.episodes.translations.with_raw_response.list(
            episode_number=0,
            series_id=0,
            season_number=0,
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncTmdbClient) -> None:
        async with async_client.tv.seasons.episodes.translations.with_streaming_response.list(
            episode_number=0,
            series_id=0,
            season_number=0,
        ) as response:
