...
class TestAccountStates:
    ...
    def test_method_retrieve(self, client: TmdbClient) -> None:
        account_state = client.tv.seasons.account_states.retrieve(
            season_number=0,
            series_id=0,
        )
    ...
    def test_raw_response_retrieve(self, client: TmdbClient) -> None:
        response = client.tv.seasons.account_states.with_raw_response.retrieve(
            season_number=0,
            series_id=0,
        )
    ...
    def test_streaming_response_retrieve(self, client: TmdbClient) -> None:
        with client.tv.seasons.account_states.with_streaming_response.retrieve(
            season_number=0,
            series_id=0,
        ) as response:
...
class TestAsyncAccountStates:
    ...
    async def test_method_retrieve(self, async_client: AsyncTmdbClient) -> None:
        account_state = await async_client.tv.seasons.account_states.retrieve(
            season_number=0,
            series_id=0,
        )
        assert_matches_type(AccountStateRetrieveResponse, account_state, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncTmdbClient) -> None:
        response = await async_client.tv.seasons.account_states.with_raw_response.retrieve(
            season_number=0,
            series_id=0,
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncTmdbClient) -> None:
        async with async_client.tv.seasons.account_states.with_streaming_response.retrieve(
            season_number=0,
            series_id=0,
        ) as response:
            assert not response.is_closed
