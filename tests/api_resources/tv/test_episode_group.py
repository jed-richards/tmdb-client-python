...
class TestEpisodeGroup:
    ...
    def test_method_retrieve(self, client: TmdbClient) -> None:
        episode_group = client.tv.episode_group.retrieve(
            "tv_episode_group_id",
        )
    ...
    def test_raw_response_retrieve(self, client: TmdbClient) -> None:
        response = client.tv.episode_group.with_raw_response.retrieve(
            "tv_episode_group_id",
        )
    ...
    def test_streaming_response_retrieve(self, client: TmdbClient) -> None:
        with client.tv.episode_group.with_streaming_response.retrieve(
            "tv_episode_group_id",
        ) as response:
    ...
    def test_path_params_retrieve(self, client: TmdbClient) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `tv_episode_group_id` but received ''"):
            client.tv.episode_group.with_raw_response.retrieve(
                "",
            )


class TestAsyncEpisodeGroup:
    parametrize = pytest.mark.parametrize("async_client", [False, True], indirect=True, ids=["loose", "strict"])

    @parametrize
    async def test_method_retrieve(self, async_client: AsyncTmdbClient) -> None:
        episode_group = await async_client.tv.episode_group.retrieve(
            "tv_episode_group_id",
        )
        assert_matches_type(EpisodeGroupRetrieveResponse, episode_group, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncTmdbClient) -> None:
        response = await async_client.tv.episode_group.with_raw_response.retrieve(
            "tv_episode_group_id",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncTmdbClient) -> None:
        async with async_client.tv.episode_group.with_streaming_response.retrieve(
            "tv_episode_group_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_retrieve(self, async_client: AsyncTmdbClient) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `tv_episode_group_id` but received ''"):
            await async_client.tv.episode_group.with_raw_response.retrieve(
                "",
            )
