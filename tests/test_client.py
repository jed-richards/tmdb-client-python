...
from tmdb_client import TmdbClient, AsyncTmdbClient, APIResponseValidationError
from tmdb_client._types import Omit
from tmdb_client._models import BaseModel, FinalRequestOptions
from tmdb_client._constants import RAW_RESPONSE_HEADER
from tmdb_client._exceptions import APIStatusError, APITimeoutError, TmdbClientError, APIResponseValidationError
from tmdb_client._base_client import (
    DEFAULT_TIMEOUT,
...
def _get_open_connections(client: TmdbClient | AsyncTmdbClient) -> int:
...
class TestTmdbClient:
    client = TmdbClient(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=True)
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "tmdb_client/_legacy_response.py",
                        "tmdb_client/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "tmdb_client/_compat.py",
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(TmdbClientError):
            with update_env(**{"TMDB_API_BEARER_TOKEN": Omit()}):
                client2 = TmdbClient(base_url=base_url, bearer_token=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_multipart_repeating_array(self, client: TmdbClient) -> None:
        request = client._build_request(
    ...
    def test_base_url_env(self) -> None:
        with update_env(TMDB_CLIENT_BASE_URL="http://localhost:5000/from/env"):
            client = TmdbClient(bearer_token=bearer_token, _strict_response_validation=True)
    ...
    def test_base_url_trailing_slash(self, client: TmdbClient) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: TmdbClient) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: TmdbClient) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = TmdbClient(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            strict_client.get("/foo", cast_to=Model)

        client = TmdbClient(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=False)
    ...
    @mock.patch("tmdb_client._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.get("/3/movie/latest").mock(side_effect=httpx.TimeoutException("Test timeout error"))

        with pytest.raises(APITimeoutError):
            self.client.get(
                "/3/movie/latest", cast_to=httpx.Response, options={"headers": {RAW_RESPONSE_HEADER: "stream"}}
            )
    ...
    def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.get("/3/movie/latest").mock(return_value=httpx.Response(500))
    ...
    def test_retries_taken(
        ...
        respx_mock.get("/3/movie/latest").mock(side_effect=retry_handler)
    ...
    def test_omit_retry_count_header(
        self, client: TmdbClient, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
        ...
        response = client.movies.latest.with_raw_response.retrieve(extra_headers={"x-stainless-retry-count": Omit()})
    ...
    def test_overwrite_retry_count_header(
        ...
        response = client.movies.latest.with_raw_response.retrieve(extra_headers={"x-stainless-retry-count": "42"})

        assert response.http_request.headers.get("x-stainless-retry-count") == "42"


class TestAsyncTmdbClient:
    client = AsyncTmdbClient(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=True)
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(TmdbClientError):
            with update_env(**{"TMDB_API_BEARER_TOKEN": Omit()}):
                client2 = AsyncTmdbClient(base_url=base_url, bearer_token=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_multipart_repeating_array(self, async_client: AsyncTmdbClient) -> None:
    ...
    def test_base_url_env(self) -> None:
        with update_env(TMDB_CLIENT_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncTmdbClient(bearer_token=bearer_token, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"
    ...
    def test_base_url_trailing_slash(self, client: AsyncTmdbClient) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncTmdbClient) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncTmdbClient) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncTmdbClient(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            await strict_client.get("/foo", cast_to=Model)

        client = AsyncTmdbClient(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=False)
    ...
    async def test_retries_taken(
        ...
        response = await client.movies.latest.with_raw_response.retrieve()
    ...
    async def test_omit_retry_count_header(
        self, async_client: AsyncTmdbClient, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = async_client.with_options(max_retries=4)
    ...
    def test_get_platform(self) -> None:
        ...
        from tmdb_client._utils import asyncify
        from tmdb_client._base_client import get_platform 
